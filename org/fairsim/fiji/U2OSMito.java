...
public class U2OSMito implements PlugIn {
	...
	double emWavelen = 600;	    // emission wavelength		    
	...
	simParam.setWienerFilter( 0.09 );   // wiener filter parameter
	simParam.setApoCutoff( 2.0 );	    // cutoff of apodization
	simParam.setApoBend( 0.9 );	    // exponent of apodization 
	
	otf.setAttenuation( 0.997, 1.5 );   // set strength (0..1) and FWHM (in 1/micron) of OTF attenuation
