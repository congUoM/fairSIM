...
public class Test3d implements PlugIn {
	...
	runReconstruction(inSt, "/home/cong/projects/CIRLData/FairSIM/Membrane3D.xml");
    }
	...
	if (true) {
		...
		System.out.println("Re :" + otfVec.get(2,2,0).re);
		System.out.println("Im :" + otfVec.get(2,2,0).im);
