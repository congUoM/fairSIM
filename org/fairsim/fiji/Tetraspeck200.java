...
public class Tetraspeck200 implements PlugIn {
	...
	otf.setAttenuation( 0.98, 1.2 );   // set strength (0..1) and FWHM (in 1/micron) of OTF attenuation
...
//	}
	...
	Tetraspeck200 sbs = new Tetraspeck200();
	sbs.run("");
    }
